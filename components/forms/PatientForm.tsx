...
import HospitalSearch from '../search/HospitalSearch' // 1. Import the new component
...
interface PatientFormProps {
    ...
    setInsuranceType: React.Dispatch<React.SetStateAction<'none' | 'government' | 'private'>>
    insuranceId: string
...
export default function PatientForm({
    ...
    const handleAadhaarChange = (
        ...
        if (value.length === 4) {
            ...
            if (nextInput && nextInput.tagName === 'INPUT') {
                nextInput.focus()
            } else if (part === 'part2' && currentInput.form?.elements.namedItem('part3')) {
                ;(currentInput.form.elements.namedItem('part3') as HTMLInputElement).focus()
            }
        }
    }
    ...
    console.log('from patient form dialog')
    return (
        <form
        ...
        >
            <div className="flex w-full flex-col gap-6 md:flex-row">
                <div className="flex flex-col gap-4 md:w-1/3">
                    ...
                    <div className="mt-2 flex items-center space-x-2">
                        <Checkbox
                            id="noAadhaar"
                            checked={!hasAadhaar}
                            onCheckedChange={(checked) => setHasAadhaar(!checked)}
                        />
                        <label htmlFor="noAadhaar" className="text-muted-foreground text-sm">
                            No Aadhaar
                        </label>
                    </div>
                        ...
                        <div className="flex gap-2">
                            {(['part1', 'part2', 'part3'] as const).map((part) => (
                                <Input
                                    ...
                                    placeholder="_ _ _ _"
                                    value={aadhaar[part]}
                                    onChange={(e) => handleAadhaarChange(e, part)}
                    ...
                    <div className="flex flex-col gap-1">
                        ...
                        <div className="mb-2 flex items-center gap-2">
                            <Checkbox
                                ...
                                onCheckedChange={(checked) => setUseAgeInstead(!!checked)}
                            />
                                ...
                                {formData.status ? (
                                    <span
                                        className={cn('font-medium', {
                                            'text-green-600': formData.status === 'Alive',
                                            'text-red-600': formData.status === 'Death',
                                            'text-blue-600': formData.status === 'Ongoing',
                                            'text-yellow-600': formData.status === 'Followup',
                                        })}
                                    >
                                        {formData.status}
                                    </span>
                ...
                <div className="flex flex-col gap-4 md:w-1/3">
                                        ...
                                        >
                                            ...
                                            <div className="mt-4 border-t pt-4">
                                                ...
                                                {selectedDiseases.some(
                                                    (d) =>
                                                        !AVAILABLE_DISEASES_LIST.solid
                                                            .concat(AVAILABLE_DISEASES_LIST.blood)
                                                            .some((x) => x.label === d)
                                                ) && (
                                                    <Input
                                                        className="mt-2"
                    ...
                    <HospitalSearch value={selectedPhc} onValueChange={setSelectedPhc} />
                    ...
                    <div className="space-y-4">
                        ...
                        <label className="flex flex-col">
                            ...
                            <Input
                                ...
                                onChange={(e) => setDiagnosedYearsAgo(e.target.value)}
                            />
                        </label>
                    </div>
                </div>
