        ...
        <div className="mb-4 flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
                ...
                <DropdownMenu>
                    ...
                    <DropdownMenuContent>
                        <DropdownMenuItem onClick={() => exportToCSV(exportData, 'patients')}>
                            Export as CSV
                        </DropdownMenuItem>
                        <DropdownMenuItem onClick={() => exportToExcel(exportData, 'patients')}>
                            Export as Excel
                        </DropdownMenuItem>
                    </DropdownMenuContent>
                </DropdownMenu>

                <Button variant="outline" onClick={() => generateDiseasePDF(exportData)}>
                    Report
                </Button>
            </div>
        </div>
